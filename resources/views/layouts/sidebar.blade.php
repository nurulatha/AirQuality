<style>
    .main-sidebar {
        background-color: #384D0C; /* Ubah warna latar belakang sesuai keinginan */
    }
    .nav-sidebar .nav-link.active {
        background-color: #676D17!important; /* Warna latar belakang saat menu aktif (hijau) */
    }
    .nav-sidebar .nav-treeview .nav-link.active {
        background-color: #dcdcdc !important; /* Warna latar belakang submenu saat menu aktif (biru) */
    }   
</style>
</style>
